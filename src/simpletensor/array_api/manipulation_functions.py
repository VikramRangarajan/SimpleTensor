...
from ._types import List, Optional, Tuple, Union, array_type


def broadcast_arrays(*arrays: array_type) -> List[array_type]:
    """
...
def broadcast_to(x: array_type, /, shape: Tuple[int, ...]) -> array_type:
    """
...
def expand_dims(x: array_type, /, *, axis: int = 0) -> array_type:
    """
...
def permute_dims(x: array_type, /, axes: Tuple[int, ...]) -> array_type:
    """
...
def reshape(
    x: array_type, /, shape: Tuple[int, ...], *, copy: Optional[bool] = None
) -> array_type:
    """
...
def squeeze(x: array_type, /, axis: Union[int, Tuple[int, ...]]) -> array_type:
    """
...
def tile(x: array_type, repetitions: Tuple[int, ...], /) -> array_type:
    """
...
def unstack(x: array_type, /, *, axis: int = 0) -> Tuple[array_type, ...]:
    """
