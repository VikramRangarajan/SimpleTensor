...
def unique_counts(x: array_type, /) -> Tuple[array_type, array_type]:
    """
...
def unique_inverse(x: array_type, /) -> Tuple[array_type, array_type]:
    """
...
def unique_values(x: array_type, /) -> array_type:
    """
