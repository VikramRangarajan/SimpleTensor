...
class _array:
    ...
    @property
    def dtype(self: array_type) -> Dtype:
        """
    ...
    @property
    def device(self: array_type) -> Device:
        """
    ...
    @property
    def mT(self: array_type) -> array_type:
        """
    ...
    @property
    def shape(self: array_type) -> Tuple[Optional[int], ...]:
        """
        Array dimensions.
    ...
    @property
    def size(self: array_type) -> Optional[int]:
        """
    ...
    @property
    def T(self: array_type) -> array_type:
        """
    ...
    def __abs__(self: array_type, /) -> array_type:
        """
    ...
    def __and__(self: array_type, other: Union[int, bool, array_type], /) -> array_type:
        """
    ...
    def __array_namespace__(
        self: array_type, /, *, api_version: Optional[str] = None
    ) -> Any:
        """
    ...
    def __bool__(self: array_type, /) -> bool:
        """
    ...
    def __complex__(self: array_type, /) -> complex:
        """
    ...
    def __dlpack_device__(self: array_type, /) -> Tuple[Enum, int]:
        """
    ...
    def __float__(self: array_type, /) -> float:
        """
    ...
    def __ge__(self: array_type, other: Union[int, float, array_type], /) -> array_type:
        """
        Computes the truth value of ``self_i >= other_i`` for each element of an array instance with the respective element of the array ``other``.
    ...
    def __getitem__(
        ...
        key: Union[
            ...
            ellipsis,
            None,
            Tuple[Union[int, slice, ellipsis, array_type, None], ...],
            array_type,
        ],
        /,
    ) -> array_type:
    ...
    def __gt__(self: array_type, other: Union[int, float, array_type], /) -> array_type:
        """
        Computes the truth value of ``self_i > other_i`` for each element of an array instance with the respective element of the array ``other``.
    ...
    def __index__(self: array_type, /) -> int:
        """
    ...
    def __int__(self: array_type, /) -> int:
        """
    ...
    def __invert__(self: array_type, /) -> array_type:
        """
    ...
    def __le__(self: array_type, other: Union[int, float, array_type], /) -> array_type:
        """
        Computes the truth value of ``self_i <= other_i`` for each element of an array instance with the respective element of the array ``other``.
    ...
    def __lshift__(self: array_type, other: Union[int, array_type], /) -> array_type:
        """
        Evaluates ``self_i << other_i`` for each element of an array instance with the respective element  of the array ``other``.
    ...
    def __lt__(self: array_type, other: Union[int, float, array_type], /) -> array_type:
        """
        Computes the truth value of ``self_i < other_i`` for each element of an array instance with the respective element of the array ``other``.
    ...
    def __matmul__(self: array_type, other: array_type, /) -> array_type:
        """
    ...
    def __neg__(self: array_type, /) -> array_type:
        """
        Evaluates ``-self_i`` for each element of an array instance.
    ...
    def __or__(self: array_type, other: Union[int, bool, array_type], /) -> array_type:
        """
        Evaluates ``self_i | other_i`` for each element of an array instance with the respective element of the array ``other``.
    ...
    def __pos__(self: array_type, /) -> array_type:
        """
        Evaluates ``+self_i`` for each element of an array instance.
    ...
    def __rshift__(self: array_type, other: Union[int, array_type], /) -> array_type:
        """
        Evaluates ``self_i >> other_i`` for each element of an array instance with the respective element of the array ``other``.
    ...
    def __xor__(self: array_type, other: Union[int, bool, array_type], /) -> array_type:
        """
        Evaluates ``self_i ^ other_i`` for each element of an array instance with the respective element of the array ``other``.
    ...
    def to_device(
        self: array_type, device: Device, /, *, stream: Optional[Union[int, Any]] = None
    ) -> array_type:
        """
