...
from ._types import Optional, Union, array_type


def abs(x: array_type, /) -> array_type:
    r"""
...
def acos(x: array_type, /) -> array_type:
    r"""
...
def acosh(x: array_type, /) -> array_type:
    r"""
...
def asin(x: array_type, /) -> array_type:
    r"""
...
def asinh(x: array_type, /) -> array_type:
    r"""
...
def atan(x: array_type, /) -> array_type:
    r"""
...
def atanh(x: array_type, /) -> array_type:
    r"""
...
def bitwise_invert(x: array_type, /) -> array_type:
    """
...
def ceil(x: array_type, /) -> array_type:
    """
...
def clip(
    x: array_type,
    /,
    min: Optional[Union[int, float, array_type]] = None,
    max: Optional[Union[int, float, array_type]] = None,
) -> array_type:
    r"""
...
def conj(x: array_type, /) -> array_type:
    """
...
def cos(x: array_type, /) -> array_type:
    r"""
...
def cosh(x: array_type, /) -> array_type:
    r"""
...
def equal(
    x1: Union[array_type, int, float, complex, bool],
    x2: Union[array_type, int, float, complex, bool],
    /,
) -> array_type:
    r"""
...
def exp(x: array_type, /) -> array_type:
    """
...
def expm1(x: array_type, /) -> array_type:
    """
...
def floor(x: array_type, /) -> array_type:
    """
...
def imag(x: array_type, /) -> array_type:
    """
...
def isfinite(x: array_type, /) -> array_type:
    """
...
def isinf(x: array_type, /) -> array_type:
    """
...
def isnan(x: array_type, /) -> array_type:
    """
...
def log(x: array_type, /) -> array_type:
    r"""
...
def log1p(x: array_type, /) -> array_type:
    r"""
...
def log2(x: array_type, /) -> array_type:
    r"""
...
def log10(x: array_type, /) -> array_type:
    r"""
...
def logical_not(x: array_type, /) -> array_type:
    """
...
def negative(x: array_type, /) -> array_type:
    """
...
def positive(x: array_type, /) -> array_type:
    """
...
def real(x: array_type, /) -> array_type:
    """
...
def reciprocal(x: array_type, /) -> array_type:
    """
...
def round(x: array_type, /) -> array_type:
    """
...
def sign(x: array_type, /) -> array_type:
    r"""
...
def signbit(x: array_type, /) -> array_type:
    r"""
...
def sin(x: array_type, /) -> array_type:
    r"""
...
def sinh(x: array_type, /) -> array_type:
    r"""
...
def square(x: array_type, /) -> array_type:
    r"""
...
def sqrt(x: array_type, /) -> array_type:
    r"""
...
def tan(x: array_type, /) -> array_type:
    r"""
...
def tanh(x: array_type, /) -> array_type:
    r"""
...
def trunc(x: array_type, /) -> array_type:
    """
