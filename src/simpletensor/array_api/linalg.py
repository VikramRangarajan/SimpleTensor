...
def cholesky(x: array_type, /, *, upper: bool = False) -> array_type:
    r"""
...
def cross(x1: array_type, x2: array_type, /, *, axis: int = -1) -> array_type:
    """
...
def det(x: array_type, /) -> array_type:
    """
...
def diagonal(x: array_type, /, *, offset: int = 0) -> array_type:
    """
...
def eigh(x: array_type, /) -> Tuple[array_type, array_type]:
    r"""
...
def eigvalsh(x: array_type, /) -> array_type:
    r"""
...
def inv(x: array_type, /) -> array_type:
    r"""
...
def matmul(x1: array_type, x2: array_type, /) -> array_type:
...
def matrix_power(x: array_type, n: int, /) -> array_type:
    """
...
def matrix_transpose(x: array_type, /) -> array_type:
    """Alias for :func:`~array_api.matrix_transpose`."""


def outer(x1: array_type, x2: array_type, /) -> array_type:
    """
...
def qr(
    x: array_type, /, *, mode: Literal["reduced", "complete"] = "reduced"
...
def slogdet(x: array_type, /) -> Tuple[array_type, array_type]:
    r"""
...
def solve(x1: array_type, x2: array_type, /) -> array_type:
    r"""
...
def svdvals(x: array_type, /) -> array_type:
    """
...
def vecdot(x1: array_type, x2: array_type, /, *, axis: int = -1) -> array_type:
